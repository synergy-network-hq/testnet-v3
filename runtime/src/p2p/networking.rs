...
use crate::p2p::messages::{
    ...
    validate_typed_finality_observer_message_size, NetworkMessage,
    SimplifiedTargetAdmissionMessage, TypedConsensusMessage, TypedFinalityObserverMessage,
...
fn dispatch_peer_message(
    ...
    match message {
        ...
        NetworkMessage::SimplifiedTargetAdmission { message } => {
