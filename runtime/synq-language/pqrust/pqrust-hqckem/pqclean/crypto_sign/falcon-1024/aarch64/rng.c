...
int PQCLEAN_FALCON1024_AARCH64_get_seed(void *seed, size_t len) {
...
void
PQCLEAN_FALCON1024_AARCH64_prng_refill(prng *p) {
...
void
PQCLEAN_FALCON1024_AARCH64_prng_get_bytes(prng *p, void *dst, size_t len) {
    uint8_t *buf;
