...
- [Current source-derived status](docs/readiness/CURRENT_STATUS.md)
- [Smart-contract production-readiness checklist](docs/readiness/SMART_CONTRACT_PRODUCTION_READINESS.md)
- [AI features operational-readiness checklist](docs/readiness/AI_FEATURES_OPERATIONAL_READINESS.md)
- [Incomplete/fake/stub implementation register](docs/readiness/INCOMPLETE_IMPLEMENTATIONS.md)

---

## 🤝 Contributing

We welcome contributions from researchers, developers, and builders. Please see [CONTRIBUTING.md](CONTRIBUTING.md) for guidelines.
