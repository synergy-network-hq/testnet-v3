...
#define PQCLEAN_MLKEM768_AVX2_CRYPTO_SECRETKEYBYTES  MLKEM_SECRETKEYBYTES
#define PQCLEAN_MLKEM768_AVX2_CRYPTO_PUBLICKEYBYTES  MLKEM_PUBLICKEYBYTES
#define PQCLEAN_MLKEM768_AVX2_CRYPTO_CIPHERTEXTBYTES MLKEM_CIPHERTEXTBYTES
#define PQCLEAN_MLKEM768_AVX2_CRYPTO_BYTES           MLKEM_SSBYTES
