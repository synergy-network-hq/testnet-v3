...
/*************************************************
* Name:        PQCLEAN_MLKEM512_AVX2_polyvec_compress
*
...
/*************************************************
* Name:        PQCLEAN_MLKEM512_AVX2_polyvec_decompress
*
* Description: De-serialize and decompress vector of polynomials;
*              approximate inverse of PQCLEAN_MLKEM512_AVX2_polyvec_compress
*
...
/*************************************************
* Name:        PQCLEAN_MLKEM512_AVX2_polyvec_tobytes
*
...
void PQCLEAN_MLKEM512_AVX2_polyvec_tobytes(uint8_t r[MLKEM_POLYVECBYTES], const polyvec *a) {
    size_t i;
    for (i = 0; i < MLKEM_K; i++) {
        PQCLEAN_MLKEM512_AVX2_poly_tobytes(r + i * MLKEM_POLYBYTES, &a->vec[i]);
    }
}

/*************************************************
* Name:        PQCLEAN_MLKEM512_AVX2_polyvec_frombytes
*
* Description: De-serialize vector of polynomials;
*              inverse of PQCLEAN_MLKEM512_AVX2_polyvec_tobytes
*
* Arguments:   - uint8_t *r: pointer to output byte array
...
void PQCLEAN_MLKEM512_AVX2_polyvec_frombytes(polyvec *r, const uint8_t a[MLKEM_POLYVECBYTES]) {
    size_t i;
    for (i = 0; i < MLKEM_K; i++) {
        PQCLEAN_MLKEM512_AVX2_poly_frombytes(&r->vec[i], a + i * MLKEM_POLYBYTES);
    }
}

/*************************************************
* Name:        PQCLEAN_MLKEM512_AVX2_polyvec_ntt
*
...
void PQCLEAN_MLKEM512_AVX2_polyvec_ntt(polyvec *r) {
    size_t i;
    for (i = 0; i < MLKEM_K; i++) {
        PQCLEAN_MLKEM512_AVX2_poly_ntt(&r->vec[i]);
    }
}

/*************************************************
* Name:        PQCLEAN_MLKEM512_AVX2_polyvec_invntt_tomont
*
...
void PQCLEAN_MLKEM512_AVX2_polyvec_invntt_tomont(polyvec *r) {
    size_t i;
    for (i = 0; i < MLKEM_K; i++) {
        PQCLEAN_MLKEM512_AVX2_poly_invntt_tomont(&r->vec[i]);
    }
}

/*************************************************
* Name:        PQCLEAN_MLKEM512_AVX2_polyvec_basemul_acc_montgomery
*
...
void PQCLEAN_MLKEM512_AVX2_polyvec_basemul_acc_montgomery(poly *r, const polyvec *a, const polyvec *b) {
    ...
    PQCLEAN_MLKEM512_AVX2_poly_basemul_montgomery(r, &a->vec[0], &b->vec[0]);
    for (i = 1; i < MLKEM_K; i++) {
        PQCLEAN_MLKEM512_AVX2_poly_basemul_montgomery(&tmp, &a->vec[i], &b->vec[i]);
        PQCLEAN_MLKEM512_AVX2_poly_add(r, r, &tmp);
    }
}

/*************************************************
* Name:        PQCLEAN_MLKEM512_AVX2_polyvec_reduce
*
...
void PQCLEAN_MLKEM512_AVX2_polyvec_reduce(polyvec *r) {
    size_t i;
    for (i = 0; i < MLKEM_K; i++) {
        PQCLEAN_MLKEM512_AVX2_poly_reduce(&r->vec[i]);
    }
}

/*************************************************
* Name:        PQCLEAN_MLKEM512_AVX2_polyvec_add
*
...
void PQCLEAN_MLKEM512_AVX2_polyvec_add(polyvec *r, const polyvec *a, const polyvec *b) {
    size_t i;
    for (i = 0; i < MLKEM_K; i++) {
        PQCLEAN_MLKEM512_AVX2_poly_add(&r->vec[i], &a->vec[i], &b->vec[i]);
    }
}
