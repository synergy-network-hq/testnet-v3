...
#if   (MLKEM_K == 2)
#ifdef MLKEM_90S
#define MLKEM_NAMESPACE(s) pqcrystals_mlkem512_90s_ref##s
#else
#define MLKEM_NAMESPACE(s) pqcrystals_mlkem512_ref##s
#endif
#elif (MLKEM_K == 3)
#ifdef MLKEM_90S
#define MLKEM_NAMESPACE(s) pqcrystals_mlkem768_90s_ref##s
#else
#define MLKEM_NAMESPACE(s) pqcrystals_mlkem768_ref##s
#endif
#elif (MLKEM_K == 4)
#ifdef MLKEM_90S
#define MLKEM_NAMESPACE(s) pqcrystals_mlkem1024_90s_ref##s
#else
#define MLKEM_NAMESPACE(s) pqcrystals_mlkem1024_ref##s
#endif
#else
