...
**************************************************/
static void cbd2(poly *r, const uint8_t buf[4*MLKEM_N/8])
{
  unsigned int i;
  __m256i f0, f1, f2, f3;
...
**************************************************/
#if MLKEM_ETA1 == 3
static void cbd3(poly *r, const uint8_t buf[6*MLKEM_N/8])
{
  unsigned int i;
  __m256i f0, f1, f2, f3;
...
void cbd_eta2(poly *r, const uint8_t buf[MLKEM_ETA1*MLKEM_N/4])
{
#if MLKEM_ETA2 != 2
