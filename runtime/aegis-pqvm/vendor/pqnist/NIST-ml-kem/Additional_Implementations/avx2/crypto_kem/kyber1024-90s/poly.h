 ...
 */
typedef struct{
  int16_t coeffs[MLKEM_N] __attribute__((aligned(32)));
} poly;
...
void poly_decompress(poly *r, const uint8_t a[MLKEM_POLYCOMPRESSEDBYTES+6]);
...
#ifndef MLKEM_90S
#define poly_getnoise_eta2_4x MLKEM_NAMESPACE(_poly_getnoise_eta2_4x)
void poly_getnoise_eta2_4x(poly *r0,
                     ...
                     uint8_t nonce3);
#if MLKEM_ETA1 == 3
#define poly_getnoise_eta1_4x MLKEM_NAMESPACE(_poly_getnoise_eta1_4x)
...
#define poly_nttunpack MLKEM_NAMESPACE(_poly_nttunpack)
