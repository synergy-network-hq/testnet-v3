...
//! # Example
//! ```
//! // if using pqrust-classicmceliece
//! use pqrust_classicmceliece::mceliece348864::*;
//! // or if using the pqrust crate:
//! // use pqrust::kem::mceliece348864::*;
//! let (pk, sk) = keypair();
...
pub const fn shared_secret_bytes() -> usize {
    ffi::PQCLEAN_MCELIECE348864_CLEAN_CRYPTO_BYTES
}
...
pub fn keypair() -> (PublicKey, SecretKey) {
    ...
    gen_keypair!(PQCLEAN_MCELIECE348864_CLEAN_crypto_kem_keypair)
}
...
pub fn encapsulate(pk: &PublicKey) -> (SharedSecret, Ciphertext) {
    ...
    encap!(PQCLEAN_MCELIECE348864_CLEAN_crypto_kem_enc, pk)
}
...
pub fn decapsulate(ct: &Ciphertext, sk: &SecretKey) -> SharedSecret {
    ...
    decap!(PQCLEAN_MCELIECE348864_CLEAN_crypto_kem_dec, ct, sk)
}
