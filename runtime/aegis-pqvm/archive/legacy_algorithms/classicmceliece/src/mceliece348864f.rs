...
//! use pqrust_classicmceliece::mceliece348864f::*;
//! // or if using the pqrust crate:
//! // use pqrust::kem::mceliece348864f::*;
//! let (pk, sk) = keypair();
...
pub fn keypair() -> (PublicKey, SecretKey) {
    ...
    gen_keypair!(PQCLEAN_MCELIECE348864F_CLEAN_crypto_kem_keypair)
}
...
pub fn encapsulate(pk: &PublicKey) -> (SharedSecret, Ciphertext) {
    ...
    encap!(PQCLEAN_MCELIECE348864F_CLEAN_crypto_kem_enc, pk)
}
...
pub fn decapsulate(ct: &Ciphertext, sk: &SecretKey) -> SharedSecret {
    ...
    decap!(PQCLEAN_MCELIECE348864F_CLEAN_crypto_kem_dec, ct, sk)
}
