...
//! use pqrust_classicmceliece::mceliece460896f::*;
//! // or if using the pqrust crate:
//! // use pqrust::kem::mceliece460896f::*;
//! let (pk, sk) = keypair();
...
pub fn encapsulate(pk: &PublicKey) -> (SharedSecret, Ciphertext) {
    ...
    encap!(PQCLEAN_MCELIECE460896F_CLEAN_crypto_kem_enc, pk)
}
...
pub fn decapsulate(ct: &Ciphertext, sk: &SecretKey) -> SharedSecret {
    ...
    decap!(PQCLEAN_MCELIECE460896F_CLEAN_crypto_kem_dec, ct, sk)
}
