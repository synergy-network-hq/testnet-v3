...
| E | Legacy active-path audit | Read-only; report only in `protocol/posy-v3/CURRENT_PROTECTED_FLOW.md` | Current production call graph | ACTIVE/COMPATIBILITY_ONLY/TEST_ONLY/DEAD classification and exact active liveness dependencies | Production-path reference scan |
