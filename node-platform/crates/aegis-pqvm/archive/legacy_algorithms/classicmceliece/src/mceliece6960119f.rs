...
//! use pqrust_classicmceliece::mceliece6960119f::*;
//! // or if using the pqrust crate:
//! // use pqrust::kem::mceliece6960119f::*;
//! let (pk, sk) = keypair();
...
pub fn encapsulate(pk: &PublicKey) -> (SharedSecret, Ciphertext) {
    ...
    encap!(PQCLEAN_MCELIECE6960119F_CLEAN_crypto_kem_enc, pk)
}
...
pub fn decapsulate(ct: &Ciphertext, sk: &SecretKey) -> SharedSecret {
    ...
    decap!(PQCLEAN_MCELIECE6960119F_CLEAN_crypto_kem_dec, ct, sk)
}
