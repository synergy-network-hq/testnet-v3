...
ffLDL_fft_inner(fpr *restrict tree,
    ...
    PQCLEAN_FALCON512_AARCH64_poly_LDLmv_fft(tmp, tree, g0, g1, g0, logn);

    PQCLEAN_FALCON512_AARCH64_poly_split_fft(g1, g1 + hn, g0, logn);
    PQCLEAN_FALCON512_AARCH64_poly_split_fft(g0, g0 + hn, tmp, logn);
...
PQCLEAN_FALCON512_AARCH64_expand_privkey(fpr *restrict expanded_key,
    ...
    PQCLEAN_FALCON512_AARCH64_smallints_to_fpr(rg, g, FALCON_LOGN);
    PQCLEAN_FALCON512_AARCH64_FFT(rg, FALCON_LOGN);

    PQCLEAN_FALCON512_AARCH64_smallints_to_fpr(rf, f, FALCON_LOGN);
    PQCLEAN_FALCON512_AARCH64_FFT(rf, FALCON_LOGN);
    PQCLEAN_FALCON512_AARCH64_poly_neg(rf, rf, FALCON_LOGN);
...
ffSampling_fft_dyntree(samplerZ samp, void *samp_ctx,
    ...
    PQCLEAN_FALCON512_AARCH64_poly_LDL_fft(g00, g01, g11, logn);
...
ffSampling_fft(samplerZ samp, void *samp_ctx,
    ...
    PQCLEAN_FALCON512_AARCH64_poly_sub(tmp, t1, z1, logn);
    PQCLEAN_FALCON512_AARCH64_poly_mul_add_fft(tmp, t0, tmp, tree, logn);
...
do_sign_tree(samplerZ samp, void *samp_ctx, int16_t *s2,
    ...
    PQCLEAN_FALCON512_AARCH64_FFT(t0, FALCON_LOGN);
    ni = fpr_inverse_of_q;
    PQCLEAN_FALCON512_AARCH64_poly_mul_fft(t1, t0, b01, FALCON_LOGN);
    ...
    PQCLEAN_FALCON512_AARCH64_poly_mul_fft(t0, tx, b00, FALCON_LOGN);
    PQCLEAN_FALCON512_AARCH64_poly_mul_add_fft(t0, t0, ty, b10, FALCON_LOGN);
    PQCLEAN_FALCON512_AARCH64_iFFT(t0, FALCON_LOGN);
...
do_sign_dyn(samplerZ samp, void *samp_ctx, int16_t *s2,
    ...
    PQCLEAN_FALCON512_AARCH64_smallints_to_fpr(b00, g, FALCON_LOGN);
    PQCLEAN_FALCON512_AARCH64_FFT(b00, FALCON_LOGN);

    PQCLEAN_FALCON512_AARCH64_smallints_to_fpr(b01, f, FALCON_LOGN);
    PQCLEAN_FALCON512_AARCH64_FFT(b01, FALCON_LOGN);
    PQCLEAN_FALCON512_AARCH64_poly_neg(b01, b01, FALCON_LOGN);

    PQCLEAN_FALCON512_AARCH64_smallints_to_fpr(b10, G, FALCON_LOGN);
    PQCLEAN_FALCON512_AARCH64_FFT(b10, FALCON_LOGN);

    PQCLEAN_FALCON512_AARCH64_smallints_to_fpr(b11, F, FALCON_LOGN);
    PQCLEAN_FALCON512_AARCH64_FFT(b11, FALCON_LOGN);
    PQCLEAN_FALCON512_AARCH64_poly_neg(b11, b11, FALCON_LOGN);

    PQCLEAN_FALCON512_AARCH64_poly_muladj_fft(t1, b00, b10, FALCON_LOGN);   

    PQCLEAN_FALCON512_AARCH64_poly_mulselfadj_fft(t0, b01, FALCON_LOGN);    
    PQCLEAN_FALCON512_AARCH64_poly_mulselfadj_fft(b00, b00, FALCON_LOGN);   
    PQCLEAN_FALCON512_AARCH64_poly_add(b00, b00, t0, FALCON_LOGN);      

    memcpy(t0, b01, FALCON_N * sizeof * b01);
    PQCLEAN_FALCON512_AARCH64_poly_muladj_add_fft(b01, t1, b01, b11, FALCON_LOGN);  

    PQCLEAN_FALCON512_AARCH64_poly_mulselfadj_fft(b10, b10, FALCON_LOGN);   
    PQCLEAN_FALCON512_AARCH64_poly_mulselfadj_add_fft(b10, b10, b11, FALCON_LOGN);    
    ...
    PQCLEAN_FALCON512_AARCH64_poly_mul_fft(tx, t0, b00, FALCON_LOGN);
    PQCLEAN_FALCON512_AARCH64_poly_mul_fft(ty, t0, b01, FALCON_LOGN);
    PQCLEAN_FALCON512_AARCH64_poly_mul_add_fft(t0, tx, t1, b10, FALCON_LOGN);
    PQCLEAN_FALCON512_AARCH64_poly_mul_add_fft(t1, ty, t1, b11, FALCON_LOGN);
