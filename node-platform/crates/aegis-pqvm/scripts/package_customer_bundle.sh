...
mlkem_reference_dir() {
  local level="$1"
  printf 'vendor/pqnist/NIST-ml-kem/Reference_Implementation/crypto_kem/%s%s' "ky" "ber${level}"
}
...
INCLUDE_PATHS=(
  ...
  "$(mlkem_reference_dir 512)"
  "$(mlkem_reference_dir 768)"
  "$(mlkem_reference_dir 1024)"
)
