...
**************************************************/
void mlkem_shake128_absorb(shake128ctx *s, const unsigned char *input, unsigned char x, unsigned char y) {
...
**************************************************/
void mlkem_shake128_squeezeblocks(unsigned char *output, size_t nblocks, shake128ctx *s) {
