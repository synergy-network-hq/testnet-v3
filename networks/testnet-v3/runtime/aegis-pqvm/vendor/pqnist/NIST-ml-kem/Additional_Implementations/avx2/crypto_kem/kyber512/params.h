...
#if   (MLKEM_K == 2)
#ifdef MLKEM_90S
#define MLKEM_NAMESPACE(s) pqcrystals_mlkem512_90s_avx2##s
#else
#define MLKEM_NAMESPACE(s) pqcrystals_mlkem512_avx2##s
#endif
#elif (MLKEM_K == 3)
#ifdef MLKEM_90S
#define MLKEM_NAMESPACE(s) pqcrystals_mlkem768_90s_avx2##s
#else
#define MLKEM_NAMESPACE(s) pqcrystals_mlkem768_avx2##s
#endif
#elif (MLKEM_K == 4)
#ifdef MLKEM_90S
#define MLKEM_NAMESPACE(s) pqcrystals_mlkem1024_90s_avx2##s
#else
#define MLKEM_NAMESPACE(s) pqcrystals_mlkem1024_avx2##s
#endif
#else
...
#define MLKEM_INDCPA_BYTES          (MLKEM_POLYVECCOMPRESSEDBYTES \
                                     + MLKEM_POLYCOMPRESSEDBYTES)

#define MLKEM_PUBLICKEYBYTES  (MLKEM_INDCPA_PUBLICKEYBYTES)
/* 32 bytes of additional space to save H(pk) */
#define MLKEM_SECRETKEYBYTES  (MLKEM_INDCPA_SECRETKEYBYTES \
