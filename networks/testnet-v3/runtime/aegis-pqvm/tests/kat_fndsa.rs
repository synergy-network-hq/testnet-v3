...
#[cfg(feature = "fndsa")]
use pqrust_traits::sign::{PublicKey as _, SignedMessage as _};
...
#[cfg(feature = "fndsa")]
#[test]
fn kat_fndsa512_open_matches_nist_vectors() {
    ...
    for case in cases.iter().take(max) {
        ...
        assert_eq!(
            msg.len(),
            mlen,
            "fndsa-512 msg length mismatch (count={})",
            case.count
        );
...
#[cfg(feature = "fndsa")]
#[test]
fn kat_fndsa1024_open_matches_nist_vectors() {
    ...
    for case in cases.iter().take(max) {
        ...
        assert_eq!(
            msg.len(),
            mlen,
            "fndsa-1024 msg length mismatch (count={})",
            case.count
        );
        ...
        assert_eq!(
            opened, msg,
            "fndsa-1024 open mismatch (count={})",
            case.count
        );
    }
}
