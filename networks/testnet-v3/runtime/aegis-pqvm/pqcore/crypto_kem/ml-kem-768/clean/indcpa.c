...
static void pack_ciphertext(uint8_t r[MLKEM_INDCPA_BYTES], polyvec *b, poly *v) {
    ...
    PQCLEAN_MLKEM768_CLEAN_poly_compress(r + MLKEM_POLYVECCOMPRESSEDBYTES, v);
}
...
static void unpack_ciphertext(polyvec *b, poly *v, const uint8_t c[MLKEM_INDCPA_BYTES]) {
    ...
    PQCLEAN_MLKEM768_CLEAN_poly_decompress(v, c + MLKEM_POLYVECCOMPRESSEDBYTES);
}
...
void PQCLEAN_MLKEM768_CLEAN_gen_matrix(polyvec *a, const uint8_t seed[MLKEM_SYMBYTES], int transposed) {
...
**************************************************/
void PQCLEAN_MLKEM768_CLEAN_indcpa_keypair_derand(uint8_t pk[MLKEM_INDCPA_PUBLICKEYBYTES],
...
**************************************************/
void PQCLEAN_MLKEM768_CLEAN_indcpa_enc(uint8_t c[MLKEM_INDCPA_BYTES],
...
**************************************************/
void PQCLEAN_MLKEM768_CLEAN_indcpa_dec(uint8_t m[MLKEM_INDCPA_MSGBYTES],
