...
#define PQCLEAN_MLKEM768_CLEAN_CRYPTO_SECRETKEYBYTES  MLKEM_SECRETKEYBYTES
#define PQCLEAN_MLKEM768_CLEAN_CRYPTO_PUBLICKEYBYTES  MLKEM_PUBLICKEYBYTES
#define PQCLEAN_MLKEM768_CLEAN_CRYPTO_CIPHERTEXTBYTES MLKEM_CIPHERTEXTBYTES
#define PQCLEAN_MLKEM768_CLEAN_CRYPTO_BYTES           MLKEM_SSBYTES
