#ifndef PQCLEAN_MLKEM1024_AARCH64_KEM_H
#define PQCLEAN_MLKEM1024_AARCH64_KEM_H
...
#define crypto_kem_keypair MLKEM_NAMESPACE(crypto_kem_keypair)
...
#define crypto_kem_enc MLKEM_NAMESPACE(crypto_kem_enc)
int crypto_kem_enc(uint8_t *ct, uint8_t *ss, const uint8_t *pk);

#define crypto_kem_dec MLKEM_NAMESPACE(crypto_kem_dec)
