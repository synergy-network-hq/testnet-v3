...
//! # Example
//! ```
//! // if using pqrust-mlkem
//! use pqrust_mlkem::mlkem512::*;
//! // or if using the pqrust crate:
//! // use pqrust::kem::mlkem512::*;
//! let (pk, sk) = keypair();
...
/// Encapsulate to a ML-KEM-512 public key
...
/// Decapsulate the received ML-KEM-512 ciphertext
