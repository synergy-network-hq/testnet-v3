...
mod tests {
    ...
    fn rpc_startup_uses_service_safe_replay_for_rpc_capable_service_roles() {
        for role in [
            crate::role_profiles::NodeRole::Archive,
            crate::role_profiles::NodeRole::CrossChain,
            crate::role_profiles::NodeRole::RpcGateway,
            crate::role_profiles::NodeRole::Indexer,
    ...
    #[test]
    fn rpc_startup_preserves_consensus_replay_for_validator() {
        for role in [crate::role_profiles::NodeRole::Validator] {
            assert!(
                !rpc_startup_uses_service_safe_replay(Some(role.profile())),
