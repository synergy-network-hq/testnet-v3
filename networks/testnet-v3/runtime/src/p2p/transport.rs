...
//!
//! Endpoint text is routing data, never a peer or validator identity. This
//! module normalizes untrusted bootstrap/discovery strings before the
//! handshake and peer-lifecycle layers consume them.
...
/// fragments are transport decoration and are intentionally excluded.
pub(crate) fn parse_dial_address(endpoint: &str) -> Option<String> {
