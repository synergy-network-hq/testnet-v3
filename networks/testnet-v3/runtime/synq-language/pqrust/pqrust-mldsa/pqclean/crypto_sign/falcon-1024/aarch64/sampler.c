...
int
PQCLEAN_FALCON1024_AARCH64_gaussian0_sampler(prng *p) {
...
int
PQCLEAN_FALCON1024_AARCH64_sampler(void *ctx, fpr mu, fpr isigma) {
    sampler_context *spc;
    int s;
    fpr r, dss, ccs;
    ...
    for (;;) {
        ...
        z0 = PQCLEAN_FALCON1024_AARCH64_gaussian0_sampler(&spc->p);
