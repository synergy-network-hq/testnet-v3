...
do_sign_dyn(samplerZ samp, void *samp_ctx, int16_t *s2,
    ...
    PQCLEAN_FALCONPADDED512_CLEAN_poly_mulselfadj_fft(t0, logn);    

    memcpy(t1, b00, n * sizeof * b00);
    PQCLEAN_FALCONPADDED512_CLEAN_poly_muladj_fft(t1, b10, logn);   
    PQCLEAN_FALCONPADDED512_CLEAN_poly_mulselfadj_fft(b00, logn);   
    PQCLEAN_FALCONPADDED512_CLEAN_poly_add(b00, t0, logn);      
    memcpy(t0, b01, n * sizeof * b01);
    PQCLEAN_FALCONPADDED512_CLEAN_poly_muladj_fft(b01, b11, logn);  
    PQCLEAN_FALCONPADDED512_CLEAN_poly_add(b01, t1, logn);      

    PQCLEAN_FALCONPADDED512_CLEAN_poly_mulselfadj_fft(b10, logn);   
    memcpy(t1, b11, n * sizeof * b11);
    PQCLEAN_FALCONPADDED512_CLEAN_poly_mulselfadj_fft(t1, logn);    
    PQCLEAN_FALCONPADDED512_CLEAN_poly_add(b10, t1, logn);      
