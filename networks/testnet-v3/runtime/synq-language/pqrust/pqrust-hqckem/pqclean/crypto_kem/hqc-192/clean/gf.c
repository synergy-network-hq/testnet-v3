...
uint16_t PQCLEAN_HQC192_CLEAN_gf_inverse(uint16_t a) {
    ...
    inv = PQCLEAN_HQC192_CLEAN_gf_square(a); 
    tmp1 = PQCLEAN_HQC192_CLEAN_gf_mul(inv, a); 
    inv = PQCLEAN_HQC192_CLEAN_gf_square(inv); 
    tmp2 = PQCLEAN_HQC192_CLEAN_gf_mul(inv, tmp1); 
    tmp1 = PQCLEAN_HQC192_CLEAN_gf_mul(inv, tmp2); 
    inv = PQCLEAN_HQC192_CLEAN_gf_mul(tmp1, inv); 
    inv = PQCLEAN_HQC192_CLEAN_gf_square(inv); 
    inv = PQCLEAN_HQC192_CLEAN_gf_square(inv); 
    inv = PQCLEAN_HQC192_CLEAN_gf_square(inv); 
    inv = PQCLEAN_HQC192_CLEAN_gf_mul(inv, tmp2); 
    inv = PQCLEAN_HQC192_CLEAN_gf_square(inv); 
    return inv;
}